...
<img alt="Raspberry Pi Imager" height="416" src="/assets/blog/2021-06-21-headless-raspberry-pi-setup/raspberry-pi-imager.png" title="Raspberry Pi Imager" width="678" />
...
<img alt="raspi-config's configuration interface" height="350" src="/assets/blog/2021-06-21-headless-raspberry-pi-setup/raspi-config.png" title="raspi-config's configuration interface" width="869" />
